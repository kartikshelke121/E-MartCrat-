            ...
            <div className="row mt-5">
              ...
              <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                ...
                <h6 className="text-uppercase fw-bold mb-4">
                  <i className="fas fa-gem me-3"></i>E-Mart
                </h6>
                <p>
                  E-Mart is guided by four principles: customer obsession rather than competitor focus, 
                  passion for invention, commitment to operational excellence, and long-term thinking. 
                  E-Mart strives to be Earth’s most customer-centric company, 
              ...
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                <p> Parsian rover, NY 10012, Mars</p>
                <p id="useful_link">
                  EmartCDAC@gmail.com
                </p>
