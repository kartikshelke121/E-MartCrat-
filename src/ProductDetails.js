              ...
              <div id="description" className="mx-5 my-3">
                ...
                <div className="form-check">
                  ...
                  <label className="form-check-label" htmlfor="exampleRadios1">
                    <span id="emartprice" style={{ fontSize: "20px" }}><b>Emart Price : &nbsp;&nbsp;&#8377;&nbsp;{(conflag == false) ? products[0]?.P_Emart_Price : config[0]?.P_Emart_Price}</b></span>
                  </label>
                </div>
                <div className="form-check">
                  ...
                  <label className="form-check-label" htmlfor="exampleRadios2">
                    <span id="emartprice" style={{ fontSize: "20px" }}><b>Emart Discount Price : &#8377;{(conflag == false) ? products[0]?.P_Emart_Disc_Price : config[0]?.P_Emart_Disc_Price} + E-Card Points : {(conflag == false) ? products[0]?.P_Emart_Disc_Points : config[0]?.P_Emart_Disc_Points} </b></span>
                  </label>
                </div>
                ...
                <div>
                  <span style={{ fontSize: "18px",color:"black"}}>Quantity : </span>
